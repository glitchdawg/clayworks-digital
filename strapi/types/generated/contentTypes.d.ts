...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    industryTags: Schema.Attribute.JSON;
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'companyName'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeroSectionHeroSection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hero banners for various pages';
  ...
  attributes: {
    ...
    layout: Schema.Attribute.Enumeration<
      ['video', 'image-left', 'image-right', 'centered']
    > &
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    hasPowerBackup: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    ...
    metroDistance: Schema.Attribute.String;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    tags: Schema.Attribute.JSON;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    travelTime: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contactPhoneDisplay: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'ClayWorks'>;
